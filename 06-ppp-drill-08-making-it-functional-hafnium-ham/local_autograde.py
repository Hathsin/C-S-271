            ...
            try:
                ...
                if inputFileConents!="": # appears to be input
                    ...
                    try:
                        ...
                        testProcess = subprocess.run(testCommand,shell=True,encoding='utf-8',stdout=subprocess.PIPE,stderr=subprocess.STDOUT,cwd=path,timeout=AUTOGRADER_TIMEOUT)
                        ...
                        print("Possible malformed .sh file; correcting and attempting again.")
